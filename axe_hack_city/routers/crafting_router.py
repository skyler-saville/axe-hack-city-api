...
def update_crafting(crafting_id: int, crafting: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    return {"message": "Crafting recipe updated", "crafting_id": crafting_id, "data": crafting}
...
def delete_crafting(crafting_id: int) -> Dict[str, Any]:
    ...
    """
    return {"message": "Crafting recipe deleted successfully", "crafting_id": crafting_id}
...
def list_craftings() -> List[Dict[str, Any]]:
    ...
    """
    return [{"crafting_id": 1, "name": "Crafting A"}, {"crafting_id": 2, "name": "Crafting B"}]
